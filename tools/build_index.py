...
def build_index():
    ...
    th_dir = os.path.join(repo_dir, "th")
    paths = []
    sentences = []
    ...
    public_dir = os.path.join(repo_dir, "website", "public")
    os.makedirs(public_dir, exist_ok=True)
    out_path = os.path.join(public_dir, "sentences.json")
    ...
    import shutil
    shutil.copy(os.path.join(repo_dir, "glossary.md"), os.path.join(public_dir, "glossary.md"))
    print("Copied glossary.md to website/public/glossary.md")
    
    # Copy th folder to website/public/th
    dest_th = os.path.join(public_dir, "th")
    if os.path.exists(dest_th):
        shutil.rmtree(dest_th)
    shutil.copytree(th_dir, dest_th)
